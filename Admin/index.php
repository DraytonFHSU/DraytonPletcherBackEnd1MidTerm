...
$sortBy = filter_input(INPUT_POST, 'sortBy', FILTER_SANITIZE_STRING) ?: filter_input(INPUT_GET, 'sortBy', FILTER_SANITIZE_STRING) ?: 'list_vehicles';
...
switch ($action) {
    ...
    case "add_make":
        ...
        if ($classID && $makeID && $typeID && $year && $model && $price) {
            ...
            header("Location: .?action=add_vehicles" . $vehicleID);
            exit(); 
        } else {
